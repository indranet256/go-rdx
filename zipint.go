...
func ZipInteger(v Integer) []byte {
	return ZipInt64(int64(v))
}

func UnzipInteger(zip []byte) Integer {
	return Integer(UnzipInt64(zip))
}

func ZipFloat(f Float) []byte {
	return ZipFloat64(float64(f))
}

func UnzipFloat(zip []byte) Float {
	return Float(UnzipFloat64(zip))
}
